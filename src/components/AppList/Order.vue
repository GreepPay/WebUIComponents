<template>
  <div
    :class="[
      ' grid grid-cols-4  items-center gap-3 py-2 pb-3 truncate cursor-pointer',
      !isLastItem && 'border-b-[1px] border-[#F0F3F6]',
      customClass,
    ]"
  >
    <div class="col-span-3 flex items-center space-x-2 flex-1">
      <div class="size-[72px] !rounded-lg">ererer
        <app-icon 
          :name="data.icon"
        />
      </div>
